...
static char doc[] = "pfish_syslog_library_info -- build-time information about pilot_fish syslog library.\vThis routine shows static build-time information about the pilot_fish syslog library installed on this system.\n";
...
int main (int argc, char **argv) {
	...
	pfish_syslog_library_info_t library_info;	// Library info structure.
	...
	pfish_syslog_library_info_get (&library_info);
